...
@Component
@EnableScheduling
@ExternalTaskSubscription("raise_incident")
public class RaiseIncidentTaskHandler implements ExternalTaskHandler {
    ...
    public void execute(ExternalTask externalTask, ExternalTaskService externalTaskService) {
        ...
        externalTaskService.handleFailure(externalTask, "This is an incident", "Incident details", 0, 0);
